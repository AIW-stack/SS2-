...
const App: React.FC = () => {
  ...
  const [onboardingStep, setOnboardingStep] = useState<'discovery' | 'persona' | 'freemium-offer'>('discovery');
  ...
  const handleReferralSuccess = (days: number) => {
    setReferralDays(prev => prev + days);
  };
        ...
        <div className="max-w-6xl mx-auto pb-24 md:pb-0">
          ...
          {activeTab === 'home' && (
            <div className="flex flex-col space-y-10">
              <MascotFin isSenior={isSenior} countryCode={countryCode} message={`Everything is in one place. I've analyzed your savings lab and market pulse insights below.`} />
                ...
                <div className="lg:col-span-2 space-y-10">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center space-x-3 px-2">
                       ...
                       <h3 className="font-black text-slate-900 text-xl">Savings Lab Insights</h3>
                    </div>
                    <MonthlyExpenses 
                      persona={persona} 
                      isPremium={isPremium} 
                ...
                <div className="space-y-10">
                   <div className="space-y-6">
                     ...
                     <ExploreSection 
                       ...
                       persona={persona} 
                       onAction={(i) => alert(`Action: ${i.actionType} for ${i.targetService}`)} 
                     />
                   </div>

                   <WinbackSection 
                    ads={winbackAds} 
                    onClaim={(ad) => alert(`Claiming offer for ${ad.brand}`)} 
